                ...
                <div className="bg-rose-200 w-1/2 justify-around h-screen flex flex-col text-center  absolute top-4 z-10" >
                    ...
                    <div className="text-justify">
                        <form className="w-full max-w-md mx-auto" action="">
                            ...
                            <button onClick={handleClick} className="w-full mt-10 bg-red-900 py-2 text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500" type="submit">Log in</button>
                            <p className="text-center mt-4">Don't have an account?<Link className="hover:underline font-medium" to='/signup'> Sign Up</Link></p>
                        </form>
                    </div>
                </div>
